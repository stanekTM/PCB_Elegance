...
Here is also the latest version of the translations release.
If you are a proud Czech, copy the translation files from the "Translations\CZ" folder to the main "PCB_Elegance_v3.52.0" directory.
